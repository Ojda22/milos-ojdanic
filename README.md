...
Be free to use and share the source code. However, please note that the template of the webpage is a [fork](https://github.com/Ojda22/beautiful-jekyll), built by > [Dean Attali](https://deanattali.com) &middot; [Demo](https://beautifuljekyll.com/)
